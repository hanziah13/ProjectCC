...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($data) {
        ...
        query_update('`order`', $data, "id = '$id'");
        setSuccess('Orderan Berhasil Diupdate!');
...
$orderan = query_select('`order`', ['where' => "id = '$id'"])[0];
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="customer_id" id="" class="form-control">
                                            <?php foreach ($customers as $key => $value): ?>
                                                <option value="<?= $value['id'] ?>" <?= $value['id'] == $orderan['customer_id'] ?> ><?= $value['name'] ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="order_number" type="text" placeholder="Order Number" name="order_number" value="<?= $orderan['order_number'] ?>" />
                                    </div>

                                    <?php 
                                    $tgl = explode(" ", $orderan['date']);
                                     ?>

                                     <div class="form-group mb-3">
                                        <label for="date" class="mb-2">Tanggal</label>
                                        <input class="form-control" id="date" type="date" placeholder="" name="date" value="<?= $tgl[0] ?>" />
                                    </div>
                                     ...
                                     <div class="form-group mb-3">
                                        ...
                                        <select name="product_id" id="" class="form-control">
                                            <?php foreach ($produks as $key => $value): ?>
                                                <option value="<?= $value['id'] ?>" <?= $value['id'] == $orderan['product_id'] ?>><?= $value['name'] ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="qty" type="number" placeholder="QTY" name="qty" value="<?= $orderan['qty'] ?>" />
                                    </div>
