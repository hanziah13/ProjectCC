...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($data) {
        ...
        query_insert('customer', $data);
        setSuccess('Customer Berhasil Ditambah!');
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="name" type="text" placeholder="Customer Name" name="name" />
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="phone" type="number" placeholder="Phone" name="phone" />
                                    </div>

                                     <div class="form-group mb-3">
                                        <label for="email" class="mb-2">Email</label>
                                        <input class="form-control" id="email" type="emai" placeholder="Email" name="email" />
                                    </div>
