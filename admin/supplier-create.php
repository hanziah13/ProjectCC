...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($data) {
        ...
        query_insert('supplier', $data);
        setSuccess("Supplier Berhasil Ditambah!");
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="contact_name" type="text" placeholder="Contact Name" name="contact_name" />
                                    </div>
