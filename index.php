...
<html lang="en">
    <head>
        ...
        <title>Shop Homepage - ClothSquare</title>
        <!-- Favicon-->
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <h3 class="display-9">Clothing and Accessories</h3>
                    <p class="lead fw-normal text-white-50 mb-0">Temukan pengalaman berbelanja online yang menyenangkan dan menguntungkan!</p>
                </div>
            </div>
        </header>
        <!-- Section-->
